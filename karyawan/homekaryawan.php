...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="home.php">Sistem Penggajian</a> 
  ...
  include '../config/koneksi.php';
    ...
    echo "<font color='white'><center>Karyawan</center></font>";
    ?>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Beranda">
          <a class="nav-link" href="homekaryawan.php">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Beranda</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Beranda">
          <a class="nav-link" href="homekaryawan.php?konten=datakaryawan">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Beranda">
          <a class="nav-link" href="homekaryawan.php?konten=datakaryawan">
            ...
            <span class="nav-link-text">Gaji Karyawan</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Beranda">
          <a class="nav-link" href="homekaryawan.php?konten=datakaryawan">
            <i class="fa fa-map-marker"></i>
            <span class="nav-link-text">Penempatan Kerja</span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <?php
          ...
          if ($konten=='homekaryawan')
            include 'berandakaryawan.php';
