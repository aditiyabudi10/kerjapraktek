      ...
      $query = mysqli_query($konek, "SELECT * FROM karyawan")or die(mysqli_error());
              ...
              { 
                ...
                while($data = mysqli_fetch_array($query)){  
                  ...
                  echo '<td  width="20"><a data-toggle="tooltip" data-placement="left" title="Detail" href=homemanager.php?konten=infodetail&&id_karyawan='.$data['id_karyawan'].'><i class="fa fa-info fa-fw"></i></a></td>';
                  $no++;  
                }
              }
