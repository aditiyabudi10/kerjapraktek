...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
   ...
   <?php
    ...
    echo "<font color='white'><center>Manager</center></font>";
    ?>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Beranda">
          <a class="nav-link" href="homemanager.php">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <?php
          ...
          if ($konten=='homemanager')
            include 'berandamanager.php';
